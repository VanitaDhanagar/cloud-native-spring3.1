...
public class TaxController {
	...
	@ResponseBody
	public ResponseEntity<String> typeMismatchExpcetionHandler(Exception exception, HttpServletRequest request) {
	...
	@ResponseBody
	public ResponseEntity<String> missingParameterExceptionHandler(Exception exception, HttpServletRequest request) {
	...
	@ResponseBody
	public ResponseEntity <String> invalidFormatExceptionHandler(HttpMessageNotReadableException exception, HttpServletRequest request) {
	...
	@ResponseBody
	public ResponseEntity<String> generalExceptionHandler(Exception exception, HttpServletRequest request) {
